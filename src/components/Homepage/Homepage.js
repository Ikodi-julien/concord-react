    ...
    <section className="homepage">
      ...
      <div className="homepage__container">
        <div className="homepage__mychannels">
          <h1 className="homepage__title"># Favoris</h1>
          {myChannels && myChannels.length > 0 ? (
            <CardBox list={myChannels} isDeletable={true} />
          ) : (
          ...
          {!noTagAlert && (
            <div className="homepage__info">
              <p>
                ...
                <Link to="/profile">
                  tu peux choisir des centres d'intérêt dans tes paramètres
                </Link>
              </p>
            </div>
          )}
          <CardBox list={recommendedChannels} isDeletable={false} />
        </div>
      </div>
