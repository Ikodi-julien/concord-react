        ...
        <div className='landing__hero'>
          ...
          <div className="landing__hero__text">
            ...
            <p className='landing__hero__description'>
              Envie de discuter de ta série du moment, de films d'horreur ou simplement de ta passion pour la cuisine ?
        </p>
            <p className='landing__hero__description'>
              Rejoins nous sur les channels de ton choix et viens échanger avec d'autres passionnés !
        </p>
          </div>
